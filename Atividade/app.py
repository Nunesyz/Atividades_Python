...
def criar_app() -> Flask:
    ...
    # Segredo forte, lido de variável de ambiente (com fallback só para a aula).
    # Nunca commite a chave real de produção.
    app.config["JWT_SECRET_KEY"] = os.environ.get(
        "JWT_SECRET_KEY", "b7f3d1e9a4c8f6205e91d3b7a0c4f8e2d6b9a1c3e5f7091b3d5f7a9c1e3f5a70"
    )
